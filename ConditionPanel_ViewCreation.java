 ...
 */
public class ConditionPanel_ViewCreation extends javax.swing.JPanel {
    ...
    public ConditionPanel_ViewCreation() {
        initComponents();
...
//        }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(340, 100, 135, 60);
        ...
        jLabel_Conditioncolumn.setBounds(210, 170, 130, 31);
        ...
        jComboBox_columnNames.setBounds(340, 180, 135, 20);
        ...
        jComboBox_operators.setBounds(510, 180, 104, 20);
        ...
        jLabel_operators.setBounds(510, 160, 80, 19);
        ...
        add(jLabel_value);
        jLabel_value.setBounds(650, 160, 44, 19);
        add(jTextField_Conditon_value);
        jTextField_Conditon_value.setBounds(650, 180, 108, 20);

        jComboBox1.setEditable(true);
        add(jComboBox1);
        jComboBox1.setBounds(780, 180, 90, 20);
        ...
        add(jLabel_ViewName);
        jLabel_ViewName.setBounds(240, 240, 90, 14);
        add(jTF_Viewname);
        jTF_Viewname.setBounds(340, 240, 94, 20);
        ...
        add(jButton_GetData);
        jButton_GetData.setBounds(480, 230, 90, 43);
        ...
        jButton_ClearDara.setBounds(650, 230, 160, 42);
        ...
        add(jScrollPane2);
        jScrollPane2.setBounds(206, 295, 690, 260);
        ...
        jButton_createView.setBounds(470, 580, 122, 39);
        ...
        add(jLabel2);
        jLabel2.setBounds(350, 40, 330, 30);
...
private void jComboBox_columnNamesItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox_columnNamesItemStateChanged
        try {
            // TODO add your handling code here:
                ...
                String str2="SELECT DISTINCT "+jComboBox_columnNames.getSelectedItem()+" FROM "+StaticData.tablename_cview+";";
...
//            }
            ...
            if(ab==1)
            {
                JOptionPane.showMessageDialog(null,"Please enter Valid Value in the TextField","ERROR",JOptionPane.ERROR_MESSAGE);
...
//                    }
                    ...
                    {
                        qry+=" from " + StaticData.tablename_cview + " where " + jComboBox_columnNames.getSelectedItem() + " " + jComboBox_operators.getSelectedItem() + " " + jComboBox1.getSelectedItem();
                    }
                    if("Starting with".equals(str))
                    {
                        qry+=" from "+StaticData.tablename_cview+" where "+jComboBox_columnNames.getSelectedItem()+" like '"+jComboBox1.getSelectedItem()+"%'";
                    }
                    if("Ending with".equals(str))
                    {
                        qry+=" from "+StaticData.tablename_cview+" where "+jComboBox_columnNames.getSelectedItem()+" like '%"+jComboBox1.getSelectedItem()+"'";
...
// TODO add your handling code here:
    ...
    //new SelectTableFrame().setVisible(true);
        MainWindowClass.jTabbedPane_view.remove(MainWindowClass.tabcv);
        MainWindowClass.jTabbedPane_view.add(new SelectTablePanel_CreateView(),MainWindowClass.tabcv);
        MainWindowClass.jTabbedPane_view.setTitleAt(MainWindowClass.tabcv,"CreateView");
        MainWindowClass.jTabbedPane_view.setSelectedIndex(MainWindowClass.tabcv);
...
private void jButton_createViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_createViewActionPerformed
        ...
        str2+=" FROM "+StaticData.tablename_cview+" WHERE "+jComboBox_columnNames.getSelectedItem()+" "+jComboBox_operators.getSelectedItem()+" "+jComboBox1.getSelectedItem()+";";
        System.out.println("View"+str2);
        EstablishConnection.connec(str2);
        JOptionPane.showMessageDialog(null,"View has been Successfully Created \n"+"QUERY:"+str2,"QUERY INFORMATION",JOptionPane.INFORMATION_MESSAGE);
...
if(confirm==0)
         {
                MainWindowClass.jTabbedPane_view.remove(MainWindowClass.tabcv);
                MainWindowClass.cv="close";
                //MainWindowClass.jTabbedPane_view.
                MyUtilities.closeTab(MainWindowClass.tabcv);
         }
    ...
    private void getColumnNames() {
        try {
            String qry1 = "select * from " + StaticData.tablename_cview;
